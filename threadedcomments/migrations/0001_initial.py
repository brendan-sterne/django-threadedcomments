...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('threadedcomments_comment', (
            ...
            ('last_child', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['threadedcomments.ThreadedComment'], null=True, on_delete=models.SET_NULL, blank=True)),
            ('tree_path', self.gf('django.db.models.fields.CharField')(max_length=500, db_index=True)),
        ))
        db.send_create_signal(u'threadedcomments', ['ThreadedComment'])
    ...
    models = {
        ...
        u'threadedcomments.threadedcomment': {
            ...
            'tree_path': ('django.db.models.fields.CharField', [], {'max_length': '500', 'db_index': 'True'})
        }
    }
